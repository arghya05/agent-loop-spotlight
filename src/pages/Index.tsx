...
const Index = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-[60] bg-header text-header-foreground border-b border-border/10">
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] font-medium tracking-wide text-header-foreground/60">Retailer-Supplier OS</span>
            </div>
          </div>
